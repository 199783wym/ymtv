    ...
    <div id="content">
      <div id="col_left">
        <div class="post">
          ...
          <div class="comments"><div class="comment"></div>
            <h2>博客登录</h2>
            <form action="login.action"class="h" method="post">
            	<p>
            	${state}
            	</p>
              <div>
      ...
      <div id="col_right">
        ...
        <div id="sidebar">
          <h2>页面导航</h2>
          <ul>
              <li class="holder"> <a href="show.action">文章列表</a> </li>
              <s:if test="#session.user.isEmpty()">
                <li class="holder"> <a href="login.jsp">博客登录</a> </li>
              </s:if>
              <s:if test="#session.user!=null">
                <li class="holder"> <a href="user/addArticle.jsp">写新博客</a> </li>
              </s:if>
          </ul>
        </div>
      </div>
